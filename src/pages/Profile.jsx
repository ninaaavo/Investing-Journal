...
export default function Profile() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-150px)] bg-[var(--color-background)] p-6 rounded-xl shadow-xl text-[var(--color-text)]">
      <h1 className="text-3xl font-bold mb-4">Hello, {user?.displayName || "Investor"} 👋</h1>
